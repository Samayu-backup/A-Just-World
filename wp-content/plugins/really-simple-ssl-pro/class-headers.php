...
class rsssl_headers {
	...
	public function insert_security_headers( string $rules ): string {
		...
		if ( rsssl_get_option( 'x_xss_protection' ) && !$this->header_is_set_by_thirdparty('x_xss_protection') ) {
	 ...
	 * @return array
	 */
	public function rest_api_clear_cache( WP_REST_Request $request): array {
